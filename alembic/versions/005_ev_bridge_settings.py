...
down_revision: str | None = "004_ev_chargers"
...
def upgrade() -> None:
    op.add_column(
        "ev_chargers",
        sa.Column("bridge_enabled", sa.Boolean(), nullable=False, server_default=sa.false()),
    )
    op.add_column(
        "ev_chargers",
    ...
    op.add_column(
        "ev_chargers", sa.Column("max_current_a", sa.Float(), nullable=False, server_default="16")
    )
    op.add_column(
        "ev_chargers", sa.Column("min_current_a", sa.Float(), nullable=False, server_default="6")
    )
    op.add_column(
        "ev_chargers", sa.Column("phases", sa.Integer(), nullable=False, server_default="3")
    )
    op.add_column(
        "ev_chargers",
        sa.Column("nominal_voltage_v", sa.Float(), nullable=False, server_default="230"),
    )
    ...
    op.add_column(
        "ev_chargers",
        sa.Column("update_interval_seconds", sa.Integer(), nullable=False, server_default="30"),
    )
    op.add_column(
        "ev_chargers",
        sa.Column("min_change_interval_seconds", sa.Integer(), nullable=False, server_default="60"),
    )
    op.add_column(
        "ev_chargers",
        sa.Column("current_hysteresis_a", sa.Float(), nullable=False, server_default="1"),
    )
    op.add_column(
        "ev_chargers",
        sa.Column("stale_timeout_seconds", sa.Integer(), nullable=False, server_default="120"),
    )
    op.add_column(
        "ev_chargers",
        sa.Column("chargeamps_api_key", sa.String(length=512), nullable=False, server_default=""),
    )
    op.add_column("ev_chargers", sa.Column("last_applied_current_a", sa.Float(), nullable=True))
    op.add_column(
        "ev_chargers", sa.Column("last_bridge_run_at", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "ev_chargers",
        sa.Column("last_heartbeat_data_at", sa.DateTime(timezone=True), nullable=True),
    )
