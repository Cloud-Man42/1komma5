...
down_revision: str | None = "003_heartbeat_settings"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "manufacturer", sa.String(length=64), nullable=False, server_default="ChargeAmps"
        ),
        sa.Column("model", sa.String(length=64), nullable=False, server_default="Halo"),
        sa.Column(
            "control_source", sa.String(length=16), nullable=False, server_default="heartbeat"
        ),
