...
_REASON_LABELS: dict[str, str] = {
    ...
    "smart_green_price": "Laddar smart — billigt elpris",
    ...
    "import_cheap_window": "Laddar smart — billigt importpris",
    "import_cheap_now": "Laddar smart — billigt importpris",
    "import_wait_cheaper": "Väntar på billigare importpris",
    "import_deadline_risk": "Deadline — laddar i tid",
    "import_price_missing": "Importpris saknas",
    "import_no_forecast": "Importprognos saknas",
    "cheap_grid_charge": "Laddar smart (nätrekommendation)",
