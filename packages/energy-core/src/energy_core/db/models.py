...
class EvChargerModel(Base):
    ...
    solar_start_threshold_w: Mapped[float] = mapped_column(Float, nullable=False, default=1500.0)
    solar_stop_threshold_w: Mapped[float] = mapped_column(Float, nullable=False, default=800.0)
    solar_start_delay_seconds: Mapped[int] = mapped_column(Integer, nullable=False, default=30)
