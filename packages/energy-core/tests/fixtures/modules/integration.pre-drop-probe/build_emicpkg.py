"""Build integration.pre-drop-probe package fixture."""
...
def _manifest(version: str = "1.0.0") -> dict:
    return {
        "module_id": "integration.pre-drop-probe",
        "name": "Pre-Drop Probe",
        "version": version,
        "module_type": "integration",
        "description": "Pre-drop adversarial probe fixture",
        "publisher": "emic-tests",
        "entrypoint": "pre_drop_probe:build_module",
...
def build(version: str = "1.0.0") -> Path:
    ...
    archive = OUT / f"integration.pre-drop-probe-{version}.emicpkg"
