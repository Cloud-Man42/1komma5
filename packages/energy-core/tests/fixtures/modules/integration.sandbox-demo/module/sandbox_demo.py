...
class SandboxDemoRuntime:
    ...
    def _signal_module_ready(self) -> None:
        try:
            self._rpc(
                "ReportModuleReady",
                {
                    "runtime_instance_id": str(self._ctx.get("runtime_instance_id", "")),
                    "module_id": str(self._ctx.get("module_id", "")),
                    "site_id": int(self._ctx.get("site_id", 1)),
                },
            )
        except Exception:
            pass
